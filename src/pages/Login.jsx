...
const Login = ({ onLogin }) => {
  ...
  // For testing convenience, pre-fill the form slightly or mention it in placeholder
  return (
    <div className="full-screen login-container">
      ...
      <div className="login-header">
        ...
        <p className="login-subtitle">Masuk untuk mengelola perangkat Anda</p>
      </div>
      ...
      <div className="login-card">
        <div className="login-card-header">
          ...
          <h2 className="login-card-title">Masuk ke Akun</h2>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="signup-text">
            Belum punya akun? <a href="#" className="signup-link">Daftar Baru</a>
          </div>
        </form>
      </div>
